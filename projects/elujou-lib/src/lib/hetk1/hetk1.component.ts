...
export class Hetk1Component {
  ...
  kirjake3 = ". Koondindikaator on elujõulisuse näitaja vahemikus 0–1, kus 0 on minimaalne ja 1 maksimaalne. Ülaltoodud joonisel on näidatud ettevõtte elujõud komponentide kaupa kõigi viie kasutatud mudeli järgi. Jooniselt näeb, millised on ettevõtte probleemsed ja tugevad küljed."
